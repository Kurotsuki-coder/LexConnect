    ...
    <div class="grid gap-4" style="grid-template-columns:repeat(auto-fit,minmax(200px,1fr))">
        @forelse($avocats as $avocat)
            @php
                ...
                $dispoLabel = ['disponible' => 'Disponible', 'en_pause' => 'En pause', 'en_vacances' => 'En vacances'][$dispo] ?? $dispo;
            ...
            <div class="bg-white border rounded-2xl overflow-hidden" style="border-color:#E8DDD9">
                ...
                <div class="p-3">
                    ...
                    <span class="inline-block mt-2 text-xs text-white px-2 py-0.5 rounded-full" style="background-color:{{ $dispoColor }}">{{ $dispoLabel }}</span>
